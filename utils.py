...
def get_args_parser():
    ...
    # select dataset
    parser.add_argument("--dataset", default="CSL_Daily", choices=['CSL_News', "CSL_Daily", "WLASL", "How2Sign", "OpenASL", "OSL-Words", "OSL-Sentences", "OSL-Sentences-CV1", "OSL-Sentences-CV2", "OSL-Sentences-CV3", "OSL-Sentences-CV4", "OSL-Sentences-CV5", "OSL-Words-Webcam", "OSL-Sentences-splitA", "OSL-Sentences-splitB", "OSL-Sentences-splitC"])
